      ...
      string currentSymbol = Symbol();
         ...
         if(filehandle > 0 ) {
           ...
           FileWrite(filehandle, GetPipsSizeForCurrencyPair());
            ...
            int copied=CopyRates(currentSymbol,Period(),0,1000000,mqlRatesArr);
            Alert("copied = " + copied);
           ...
           // int copied15Minutes=CopyRates(currentSymbol,PERIOD_M15,0,10000,mqlRates15MinutesArr);
            ...
            //int copiedDaily=CopyRates(/*Symbol()*/currentSymbol,/*_Period*/1440,0,10000,mqlRatesDailyArr);
               ...
               int counter=1;
               int loopCount = 0;
               //FileWrite(filehandle,"Time", "Period", "Open","High","Low","Close","Volume","Bollinger Bands 20 high", "Moving Average 20", "Bollinger Bands");
               for(int i=0; i<copied; i++)
               {
                     ...
                     /*iBands(currentSymbol, Period(), 20, 2, 0, PRICE_CLOSE, MODE_UPPER, ArraySize(mqlRatesArr) - i - 1),
                     iMA(currentSymbol,Period(),20,0,MODE_SMA,PRICE_CLOSE,ArraySize(mqlRatesArr) - i - 1),
                     iBands(currentSymbol, Period(), 20, 2, 0, PRICE_CLOSE, MODE_LOWER, ArraySize(mqlRatesArr) - i - 1),
                     ...
                     iRSI(currentSymbol,Period(),7,PRICE_CLOSE,ArraySize(mqlRatesArr) - i - 1),*///,
